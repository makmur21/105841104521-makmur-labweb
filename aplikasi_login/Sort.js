  ...
  const [products, setProducts] = useState([
    {
      ...
      image: require('../assets/poto10.png'),
      price: 95,
      rating: 5,
      ratingCount: 11,
      loved: false,
    ...
    {
      name: 'Blouse',
      image: require('../assets/poto11.png'),
      originalPrice: 215,
      price: 145,
      rating: 5,
      ratingCount: 16,
  ...
  const renderStars = (rating, ratingCount) => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <Image
          key={i}
          source={i <= rating ? require('../assets/Star-aktif.png') : require('../assets/Star-inactif.png')}
  ...
  const sortProductsByOption = (option) => {
    switch (option) {
      case 'Popular':
        ...
        break;
      case 'Newest':
        // Implement logic for sorting by newest
        break;
      case 'Customer Review':
        // Implement logic for sorting by customer review
        break;
  ...
  const renderItem = ({ item, index }) => (
    <View style={styles.productItem}>
      ...
      <TouchableOpacity style={styles.loveButton} onPress={() => toggleLove(index)}>
        <Image
          source={item.loved ? require('../assets/favorites_activated.png') : require('../assets/favorites_inactive.png')}
